function Knob(elem, scale){
	...
	this.dial.onmousedown = function(originalEvent){
		document.onmousemove = function(event){
			...
			// console.log(originalEvent.pageX + ', ' + originalEvent.pageY + ': ' + event.pageX + ', ' + event.pageY + ': dist =' + this.distance(originalEvent.pageX, originalEvent.pageY, event.pageX, event.pageY)
